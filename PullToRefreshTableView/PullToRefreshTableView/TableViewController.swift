...
//
//  Created by Agile Infoways on 21/11/14.
//  
//
...
class TableViewController: UITableViewController {
    ...
    var numberOfRecordsPerAPICall:NSInteger=10 // Pass number of record you want per api call.
    ...
    var APIURL:NSString = "" // Pass your api URL here and make json format for repsonse as per local json file
    ...
    func getDataUsingLocalJSONFile(){
        ...
        var jsonFilePath:NSString = NSBundle.mainBundle().pathForResource("response", ofType: "json")!
    ...
    func callApi() {
        ...
        var request:NSURLRequest = NSURLRequest(URL: apiUrl, cachePolicy: NSURLRequestCachePolicy.UseProtocolCachePolicy, timeoutInterval: 60) as NSURLRequest
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell:TableViewCustomCell = tableView.dequeueReusableCellWithIdentifier("cell", forIndexPath: indexPath) as TableViewCustomCell
        ...
        if (currentData.objectForKey("title") != nil){
            cell.lblText.text = currentData.objectForKey("title") as NSString
        }else{
            cell.lblText.text = "Failed To Download Data"
        }
        
        cell.imgImageView.image = UIImage(named: currentData.objectForKey("image") as NSString)
    ...
    override func tableView(tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        ...
        if(isTableViewScrollToBotton == true){
            ...
            actInd = UIActivityIndicatorView(frame: CGRectMake(footerView.frame.width/2-25,0, 50, 50)) as UIActivityIndicatorView
            actInd.hidden=false
